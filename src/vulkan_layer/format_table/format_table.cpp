...
// ═══════════════════════════════════════════════════════════════════════════════
namespace VK {
    static constexpr VkFormat UNDEFINED                       = 0;
    static constexpr VkFormat R4G4_UNORM_PACK8                = 1;
    static constexpr VkFormat R4G4B4A4_UNORM_PACK16           = 2;
    static constexpr VkFormat B4G4R4A4_UNORM_PACK16           = 3;
    static constexpr VkFormat R5G6B5_UNORM_PACK16             = 4;
    static constexpr VkFormat B5G6R5_UNORM_PACK16             = 5;
    static constexpr VkFormat R5G5B5A1_UNORM_PACK16           = 6;
    static constexpr VkFormat B5G5R5A1_UNORM_PACK16           = 7;
    static constexpr VkFormat A1R5G5B5_UNORM_PACK16           = 8;
    static constexpr VkFormat R8_UNORM                        = 9;
    static constexpr VkFormat R8_SNORM                        = 10;
    static constexpr VkFormat R8_USCALED                      = 11;
    static constexpr VkFormat R8_SSCALED                      = 12;
    static constexpr VkFormat R8_UINT                         = 13;
    static constexpr VkFormat R8_SINT                         = 14;
    static constexpr VkFormat R8_SRGB                         = 15;
    static constexpr VkFormat R8G8_UNORM                      = 16;
    static constexpr VkFormat R8G8_SNORM                      = 17;
    static constexpr VkFormat R8G8_USCALED                    = 18;
    static constexpr VkFormat R8G8_SSCALED                    = 19;
    static constexpr VkFormat R8G8_UINT                       = 20;
    static constexpr VkFormat R8G8_SINT                       = 21;
    static constexpr VkFormat R8G8_SRGB                       = 22;
    static constexpr VkFormat R8G8B8_UNORM                    = 23;
    static constexpr VkFormat R8G8B8_SNORM                    = 24;
    static constexpr VkFormat R8G8B8_USCALED                  = 25;
    static constexpr VkFormat R8G8B8_SSCALED                  = 26;
    static constexpr VkFormat R8G8B8_UINT                     = 27;
    static constexpr VkFormat R8G8B8_SINT                     = 28;
    static constexpr VkFormat R8G8B8_SRGB                     = 29;
    static constexpr VkFormat B8G8R8_UNORM                    = 30;
    static constexpr VkFormat B8G8R8_SNORM                    = 31;
    static constexpr VkFormat B8G8R8_USCALED                  = 32;
    static constexpr VkFormat B8G8R8_SSCALED                  = 33;
    static constexpr VkFormat B8G8R8_UINT                     = 34;
    static constexpr VkFormat B8G8R8_SINT                     = 35;
    static constexpr VkFormat B8G8R8_SRGB                     = 36;
    static constexpr VkFormat R8G8B8A8_UNORM                  = 37;
    static constexpr VkFormat R8G8B8A8_SNORM                  = 38;
    static constexpr VkFormat R8G8B8A8_USCALED                = 39;
    static constexpr VkFormat R8G8B8A8_SSCALED                = 40;
    static constexpr VkFormat R8G8B8A8_UINT                   = 41;
    static constexpr VkFormat R8G8B8A8_SINT                   = 42;
    static constexpr VkFormat R8G8B8A8_SRGB                   = 43;
    static constexpr VkFormat B8G8R8A8_UNORM                  = 44;
    static constexpr VkFormat B8G8R8A8_SNORM                  = 45;
    static constexpr VkFormat B8G8R8A8_USCALED                = 46;
    static constexpr VkFormat B8G8R8A8_SSCALED                = 47;
    static constexpr VkFormat B8G8R8A8_UINT                   = 48;
    static constexpr VkFormat B8G8R8A8_SINT                   = 49;
    static constexpr VkFormat B8G8R8A8_SRGB                   = 50;
    static constexpr VkFormat A8B8G8R8_UNORM_PACK32           = 51;
    static constexpr VkFormat A8B8G8R8_SNORM_PACK32           = 52;
    static constexpr VkFormat A8B8G8R8_USCALED_PACK32         = 53;
    static constexpr VkFormat A8B8G8R8_SSCALED_PACK32         = 54;
    static constexpr VkFormat A8B8G8R8_UINT_PACK32            = 55;
    static constexpr VkFormat A8B8G8R8_SINT_PACK32            = 56;
    static constexpr VkFormat A8B8G8R8_SRGB_PACK32            = 57;
    static constexpr VkFormat A2R10G10B10_UNORM_PACK32        = 58;
    static constexpr VkFormat A2R10G10B10_SNORM_PACK32        = 59;
    static constexpr VkFormat A2R10G10B10_UINT_PACK32         = 60;
    static constexpr VkFormat A2R10G10B10_SINT_PACK32         = 61;
    static constexpr VkFormat A2B10G10R10_UNORM_PACK32        = 64;
    static constexpr VkFormat A2B10G10R10_SNORM_PACK32        = 65;
    static constexpr VkFormat A2B10G10R10_UINT_PACK32         = 66;
    static constexpr VkFormat A2B10G10R10_SINT_PACK32         = 67;
    static constexpr VkFormat R16_UNORM                       = 70;
    static constexpr VkFormat R16_SNORM                       = 71;
    static constexpr VkFormat R16_USCALED                     = 72;
    static constexpr VkFormat R16_SSCALED                     = 73;
    static constexpr VkFormat R16_UINT                        = 74;
    static constexpr VkFormat R16_SINT                        = 75;
    static constexpr VkFormat R16_SFLOAT                      = 76;
    static constexpr VkFormat R16G16_UNORM                    = 77;
    static constexpr VkFormat R16G16_SNORM                    = 78;
    static constexpr VkFormat R16G16_USCALED                  = 79;
    static constexpr VkFormat R16G16_SSCALED                  = 80;
    static constexpr VkFormat R16G16_UINT                     = 81;
    static constexpr VkFormat R16G16_SINT                     = 82;
    static constexpr VkFormat R16G16_SFLOAT                   = 83;
    static constexpr VkFormat R16G16B16_UNORM                 = 84;
    static constexpr VkFormat R16G16B16_SNORM                 = 85;
    static constexpr VkFormat R16G16B16_USCALED               = 86;
    static constexpr VkFormat R16G16B16_SSCALED               = 87;
    static constexpr VkFormat R16G16B16_UINT                  = 88;
    static constexpr VkFormat R16G16B16_SINT                  = 89;
    static constexpr VkFormat R16G16B16_SFLOAT                = 90;
    static constexpr VkFormat R16G16B16A16_UNORM              = 91;
    static constexpr VkFormat R16G16B16A16_SNORM              = 92;
    static constexpr VkFormat R16G16B16A16_USCALED            = 93;
    static constexpr VkFormat R16G16B16A16_SSCALED            = 94;
    static constexpr VkFormat R16G16B16A16_UINT               = 95;
    static constexpr VkFormat R16G16B16A16_SINT               = 96;
    static constexpr VkFormat R16G16B16A16_SFLOAT             = 97;
    static constexpr VkFormat R32_UINT                        = 98;
    static constexpr VkFormat R32_SINT                        = 99;
    static constexpr VkFormat R32_SFLOAT                      = 100;
    static constexpr VkFormat R32G32_UINT                     = 101;
    static constexpr VkFormat R32G32_SINT                     = 102;
    static constexpr VkFormat R32G32_SFLOAT                   = 103;
    static constexpr VkFormat R32G32B32_UINT                  = 104;
    static constexpr VkFormat R32G32B32_SINT                  = 105;
    static constexpr VkFormat R32G32B32_SFLOAT                = 106;
    static constexpr VkFormat R32G32B32A32_UINT               = 107;
    static constexpr VkFormat R32G32B32A32_SINT               = 108;
    static constexpr VkFormat R32G32B32A32_SFLOAT             = 109;
    static constexpr VkFormat R64_UINT                        = 110;
    static constexpr VkFormat R64_SINT                        = 111;
    static constexpr VkFormat R64_SFLOAT                      = 112;
    static constexpr VkFormat R64G64_UINT                     = 113;
    static constexpr VkFormat R64G64_SINT                     = 114;
    static constexpr VkFormat R64G64_SFLOAT                   = 115;
    static constexpr VkFormat R64G64B64_UINT                  = 116;
    static constexpr VkFormat R64G64B64_SINT                  = 117;
    static constexpr VkFormat R64G64B64_SFLOAT                = 118;
    static constexpr VkFormat R64G64B64A64_UINT               = 119;
    static constexpr VkFormat R64G64B64A64_SINT               = 120;
    static constexpr VkFormat R64G64B64A64_SFLOAT             = 121;
    static constexpr VkFormat B10G11R11_UFLOAT_PACK32         = 122;
    static constexpr VkFormat E5B9G9R9_UFLOAT_PACK32          = 123;
    static constexpr VkFormat D16_UNORM                       = 124;
    static constexpr VkFormat X8_D24_UNORM_PACK32             = 125;
    static constexpr VkFormat D32_SFLOAT                      = 126;
    static constexpr VkFormat S8_UINT                         = 127;
    static constexpr VkFormat D16_UNORM_S8_UINT               = 128;
    static constexpr VkFormat D24_UNORM_S8_UINT               = 129;
    static constexpr VkFormat D32_SFLOAT_S8_UINT              = 130;
    static constexpr VkFormat BC1_RGB_UNORM_BLOCK             = 131;
    static constexpr VkFormat BC1_RGB_SRGB_BLOCK              = 132;
    static constexpr VkFormat BC1_RGBA_UNORM_BLOCK            = 133;
    static constexpr VkFormat BC1_RGBA_SRGB_BLOCK             = 134;
    static constexpr VkFormat BC2_UNORM_BLOCK                 = 135;
    static constexpr VkFormat BC2_SRGB_BLOCK                  = 136;
    static constexpr VkFormat BC3_UNORM_BLOCK                 = 137;
    static constexpr VkFormat BC3_SRGB_BLOCK                  = 138;
    static constexpr VkFormat BC4_UNORM_BLOCK                 = 139;
    static constexpr VkFormat BC4_SNORM_BLOCK                 = 140;
    static constexpr VkFormat BC5_UNORM_BLOCK                 = 141;
    static constexpr VkFormat BC5_SNORM_BLOCK                 = 142;
    static constexpr VkFormat BC6H_UFLOAT_BLOCK               = 143;
    static constexpr VkFormat BC6H_SFLOAT_BLOCK               = 144;
    static constexpr VkFormat BC7_UNORM_BLOCK                 = 145;
    static constexpr VkFormat BC7_SRGB_BLOCK                  = 146;
    static constexpr VkFormat ETC2_R8G8B8_UNORM_BLOCK         = 147;
    static constexpr VkFormat ETC2_R8G8B8_SRGB_BLOCK          = 148;
    static constexpr VkFormat ETC2_R8G8B8A1_UNORM_BLOCK       = 149;
    static constexpr VkFormat ETC2_R8G8B8A1_SRGB_BLOCK        = 150;
    static constexpr VkFormat ETC2_R8G8B8A8_UNORM_BLOCK       = 151;
    static constexpr VkFormat ETC2_R8G8B8A8_SRGB_BLOCK        = 152;
    static constexpr VkFormat EAC_R11_UNORM_BLOCK             = 153;
    static constexpr VkFormat EAC_R11_SNORM_BLOCK             = 154;
    static constexpr VkFormat EAC_R11G11_UNORM_BLOCK          = 155;
    static constexpr VkFormat EAC_R11G11_SNORM_BLOCK          = 156;
    static constexpr VkFormat ASTC_4x4_UNORM_BLOCK            = 157;
    static constexpr VkFormat ASTC_4x4_SRGB_BLOCK             = 158;
    static constexpr VkFormat ASTC_5x4_UNORM_BLOCK            = 159;
    static constexpr VkFormat ASTC_5x4_SRGB_BLOCK             = 160;
    static constexpr VkFormat ASTC_5x5_UNORM_BLOCK            = 161;
    static constexpr VkFormat ASTC_5x5_SRGB_BLOCK             = 162;
    static constexpr VkFormat ASTC_6x5_UNORM_BLOCK            = 163;
    static constexpr VkFormat ASTC_6x5_SRGB_BLOCK             = 164;
    static constexpr VkFormat ASTC_6x6_UNORM_BLOCK            = 165;
    static constexpr VkFormat ASTC_6x6_SRGB_BLOCK             = 166;
    static constexpr VkFormat ASTC_8x5_UNORM_BLOCK            = 169;
    static constexpr VkFormat ASTC_8x5_SRGB_BLOCK             = 170;
    static constexpr VkFormat ASTC_8x6_UNORM_BLOCK            = 171;
    static constexpr VkFormat ASTC_8x6_SRGB_BLOCK             = 172;
    static constexpr VkFormat ASTC_8x8_UNORM_BLOCK            = 173;
    static constexpr VkFormat ASTC_8x8_SRGB_BLOCK             = 174;
    static constexpr VkFormat ASTC_10x5_UNORM_BLOCK           = 175;
    static constexpr VkFormat ASTC_10x5_SRGB_BLOCK            = 176;
    static constexpr VkFormat ASTC_10x6_UNORM_BLOCK           = 177;
    static constexpr VkFormat ASTC_10x6_SRGB_BLOCK            = 178;
    static constexpr VkFormat ASTC_10x8_UNORM_BLOCK           = 179;
    static constexpr VkFormat ASTC_10x8_SRGB_BLOCK            = 180;
    static constexpr VkFormat ASTC_10x10_UNORM_BLOCK          = 181;
    static constexpr VkFormat ASTC_10x10_SRGB_BLOCK           = 182;
    static constexpr VkFormat ASTC_12x10_UNORM_BLOCK          = 183;
    static constexpr VkFormat ASTC_12x10_SRGB_BLOCK           = 184;
    static constexpr VkFormat ASTC_12x12_UNORM_BLOCK          = 185;
    static constexpr VkFormat ASTC_12x12_SRGB_BLOCK           = 186;
} // namespace VK
...
#define FMT(vk, mtl, fb, bw, bh, bpb, cc, d, s, cmp, srgb, flt, un, sn, ui, si, filt, rend, bld, nm) \
    FormatInfo{(vk), (mtl), (fb), (uint8_t)(bw), (uint8_t)(bh), (uint8_t)(bpb), (uint8_t)(cc), \
...
static std::array<FormatInfo, kFormatTableSize> sFormatTable = []() {
    ...
    auto noMtl = [](VkFormat vk, VkFormat fb, uint8_t bw, uint8_t bh, uint8_t bpb,
        ...
        return {vk, MTL::Invalid, fb, bw, bh, bpb, cc, d, s, cmp, srgb, flt, un, sn, ui, si,
