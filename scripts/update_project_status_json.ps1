...
$status = [ordered]@{
    ...
    nextNonMacSteps = @(
        "Promote the shared runtime-plan contract into future launcher-side execution or wrapper flows now that import, preview, guided actions, copy helpers, prep-sheet export, and in-app prep preview are in place.",
