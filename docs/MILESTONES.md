...
| Launcher runtime-bundle artifact preview | IN PLACE | `launcher/RuntimeBundleArtifactPreview.swift`, `launcher/BridgeViewModel.swift`, and `launcher/ContentView.swift` now surface setup checklist, setup-script, and lint summaries from imported runtime bundles |
