...
| Runtime launch-plan builder | IN PLACE | `src/common/runtime_launch_plan.*` resolves profiles into backend/install/env/args/runtime policy, can persist and reload schema-versioned JSON plans, and is covered in host tests |
